...
- Fix #3735
- Fix #3729: explain how to use Avenue in a modular way
...
Avenue v1 is a **full rewrite** of the framework using [**Dart Sass**](https://sass-lang.com/dart-sass/), which is the the primary implementation of Sass. While this affects a few development details, everything has been done to make the transition **as easy as possible**.

## What remains the same

**All HTML snippets are the same**. This means you don't need to update your markup. **This is important** because it means, if you're using Avenue straight "out of the box", you don't need to change anything.

You can just swap `avenue@0.9.4/css/avenue.min.css` with `avenue@1.0.0/css/avenue.min.css` and everything will work. Things will look slightly different, but they will still work.

## What changes

* [**Dart Sass**](https://sass-lang.com/dart-sass/) is used to build Avenue
  * if you use the `sass` npm package, you're already using Dart Sass
* [**CSS Variables**](https://avenue.io/documentation/features/css-variables/) are used instead of literals: `color: var(--avenue-primary);` instead of `color: hsl(171deg, 100%, 41%);`, which means you can customize Avenue with CSS only (without using Sass)
* Customization by setting your own value for Sass variables works differently. See [how to customize Avenue with Sass](https://avenue.io/documentation/customize/).

## What's new (i.e. did not exist before)

* The notion of [**Themes**](https://avenue.io/documentation/features/themes/) is introduced: a theme is a collection of CSS variables within a context, and is the best approach to customize Avenue
* As a result, a Theme for [**Dark Mode**](https://avenue.io/documentation/features/dark-mode/) is included
* [**Color Palettes**](https://avenue.io/documentation/features/color-palettes/) are created for each of the 7 primary colors
* [**Skeleton loaders**](https://avenue.io/documentation/features/skeletons/) exist as standalone components but also as variants of other components
* You can add a **prefix** to all your Avenue classes so that `.button` becomes `.my-prefix-button`
  * a pre-built prefixed version exists as one of the [**alternative versions**](https://avenue.io/documentation/start/alternative-versions/)
...
- Fix #3461 Avenue logo with wordmark in SVG
...
If you were importing `utilities/_all` or even `avenue.sass` directly, no change is required.
...
If you were simply importing the whole of Avenue with `@import "~/avenue/avenue.sass"` or similar, you won't have to change anything, and everything will work as before.
...
Avenue now has **RTL support**.

By setting the Sass flag `$rtl` to `true`, you can create an RTL version of Avenue, thanks to 4 new Sass mixins:
...
The Avenue package now also comes with a `avenue-rtl.css` and `avenue-rtl.min.css` file to be used straight away.

### Spacing helpers

Avenue now has **spacing helpers**: https://avenue.io/documentation/helpers/spacing-helpers/

<p>Avenue provides <strong>margin</strong> <code>m*</code> and <strong>padding</strong> <code>p*</code> helpers in all <strong>directions</strong>:</p>
...
- Fix #2741 -> Create `avenueRgba()` function to support `inherit` value
...
Simply set a value when importing Avenue:
...
- 🎉 #1747 New `$custom-colors` and `$custom-shades` variable for adding your own colors and shades to Avenue's `$colors` and `$shades` maps respectively
...
- 🎉 [List of buttons](https://avenue.io/documentation/elements/button/#list-of-buttons)
...
- 🎉 #280 [File upload element](https://avenue.io/documentation/form/file/)
...
- 🎉 [List of tags](https://avenue.io/documentation/elements/tag/#list-of-tags)
...
- [Starter template](https://avenue.io/documentation/overview/start/#starter-template)
- [Colors page](https://avenue.io/documentation/overview/colors/)
- [Typography helpers](https://avenue.io/documentation/modifiers/typography-helpers/)
...
- New [dropdown button](https://avenue.io/documentation/components/dropdown/)!
...
- Add re-avenue and react-avenue (#809) @kulakowka
...
- `avenue` folder renamed to `sass` to avoid the redundant `avenue/avenue` path
...
- all variables are now `!default` so you can set your custom variables before importing Avenue
